...
class GatedStudy:
    ...
    patient_weight: str = ""          # kg (0010,1030)
    patient_size: str = ""            # m  (0010,1020)
    study_date: str = ""
    study_time: str = ""
...
def load(path: str, verbose: bool = False) -> GatedStudy:
    ...
    patient_weight = _to_clean_str(_get(ds, (0x0010, 0x1030), ""))
    patient_size = _to_clean_str(_get(ds, (0x0010, 0x1020), ""))
