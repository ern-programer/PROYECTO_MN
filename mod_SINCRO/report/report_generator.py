...
def generate_report(
	*,
	...
	img_files = [
		...
		("ct_fusion_sa_stress.png", "Fusión SPECT/CT en ejes cardiacos (SA base→ápex) · Esfuerzo: perfusión en color sobre anatomía CT."),
		("ct_fusion_sa_rest.png", "Fusión SPECT/CT en ejes cardiacos (SA base→ápex) · Reposo: perfusión en color sobre anatomía CT."),
